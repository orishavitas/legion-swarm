...
## Corpus Check
- 30 files · ~66,309 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 125 nodes · 217 edges · 16 communities detected
- Extraction: 73% EXTRACTED · 27% INFERRED · 0% AMBIGUOUS · INFERRED: 59 edges (avg confidence: 0.79)
...
9. `record_monday_preflight()` - 6 edges
10. `MondayPreflight` - 5 edges
...
Cohesion: 0.35
Nodes (10): load_monday_preflight(), main(), MondayPreflight, preflight_path(), Durable Monday MCP write-access preflight records., record_monday_preflight(), _render(), test_load_monday_preflight_returns_none_when_missing() (+2 more)
...
## Knowledge Gaps
- **7 isolated node(s):** `Read agent status: Claude state file + Codex inbox snapshots.`, `v1 command-bar actions. Local only — no network beyond plain git push.`, `Load and validate legion/config.json.`, `Durable Monday MCP write-access preflight records.`, `Multi-file NDJSON tailer — stateful, polling, never raises.` (+2 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 8`** (2 nodes): `__init__.py`, `Legion Nerve Center - cross-repo live TUI dashboard. v1 read-only.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 9`** (2 nodes): `sync-vault-hard-truths.ps1`, `Sync-File()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 10`** (1 nodes): `__main__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 11`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 12`** (1 nodes): `claude-dialogue-log.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 13`** (1 nodes): `codex-dialogue-check.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (1 nodes): `codex-handoff.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (1 nodes): `codex-watchdog-check.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `main()` connect `Community 4` to `Community 2`, `Community 3`, `Community 5`, `Community 7`?**
  _High betweenness centrality (0.214) - this node is a cross-community bridge._
- **Why does `load_config()` connect `Community 2` to `Community 4`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `MultiTailer` connect `Community 5` to `Community 4`?**
