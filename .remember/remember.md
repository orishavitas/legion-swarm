...
## Next
1. Invoke `superpowers:writing-plans` on the mac design spec to produce the implementation plan.
2. Create `legion-swarm-mac` repo and scaffold it per the plan.
3. Run `scripts/verify-monday.ts` to confirm Monday API is live before first Legion session.
